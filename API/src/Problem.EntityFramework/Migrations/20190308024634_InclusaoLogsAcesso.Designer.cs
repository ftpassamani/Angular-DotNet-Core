...
namespace Problem.EntityFramework.Migrations
{
    ...
    [Migration("20190308024634_InclusaoLogsAcesso")]
    partial class InclusaoLogsAcesso
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Problem.Core.Log.LogAcesso", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Problem.Core.Permissions.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Problem.Core.Roles.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasData(
                        new { Id = new Guid("f22bce18-06ec-474a-b9af-a9de2a7b8263"), ConcurrencyStamp = "5c1d62e0-c07d-4ad0-99ff-80c8f6dd8898", IsSystemDefault = true, Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = new Guid("11d14a89-3a93-4d39-a94f-82b823f0d4ce"), ConcurrencyStamp = "4c228d3f-187e-4928-827a-422dca98c199", IsSystemDefault = true, Name = "Member", NormalizedName = "MEMBER" }
                    );
                });

            modelBuilder.Entity("Problem.Core.Roles.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Problem.Core.Roles.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId");
            ...
            modelBuilder.Entity("Problem.Core.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Problem.Core.Users.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Problem.Core.Users.UserRole", b =>
                {
                    b.Property<Guid>("UserId");
            ...
            modelBuilder.Entity("Problem.Core.Users.UserToken", b =>
                {
                    b.Property<Guid>("UserId");
            ...
            modelBuilder.Entity("Problem.Core.Roles.RoleClaim", b =>
                {
                    b.HasOne("Problem.Core.Roles.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Problem.Core.Roles.RolePermission", b =>
                {
                    b.HasOne("Problem.Core.Permissions.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Problem.Core.Roles.Role", "Role")
                        .WithMany("RolePermissions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Problem.Core.Users.UserClaim", b =>
                {
                    b.HasOne("Problem.Core.Users.User")
                        .WithMany()
            ...
            modelBuilder.Entity("Problem.Core.Users.UserRole", b =>
                {
                    ...
                    b.HasOne("Problem.Core.Users.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
