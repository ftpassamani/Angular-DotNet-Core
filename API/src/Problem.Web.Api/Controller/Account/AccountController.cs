...
using Problem.Application.Account.Dto;
...
namespace Problem.Web.Api.Controller.Account
{
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult<LoginOutput>> Login([FromBody]LoginInput input)
        {
            ...
            var logAcesso = new LogAcessoInput() { Login = input.UserNameOrEmail };
            ...
            return Ok(new LoginOutput { Token = new JwtSecurityTokenHandler().WriteToken(token), UserName = input.UserNameOrEmail });
        }
